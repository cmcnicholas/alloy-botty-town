...
namespace NetTopologySuite.Geometries
{
   ...
   * (or equivalently neither covers the other),
        ...
        //public abstract IGeometry Buffer(double distance, BufferStyle endCapStyle);
        //public abstract IGeometry Buffer(double distance, int quadrantSegments, BufferStyle endCapStyle);
        //public abstract IGeometry Buffer(double distance, int quadrantSegments, EndCapStyle endCapStyle);
    }
